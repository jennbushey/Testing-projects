...
public class RangeTest {
    ...
    // Eric test case for contains() method. The range of the object is set to
    // (-10,10)
    // The following tests use the boundary techniques to test the contains() method
    // if
    ...
    // The following tests use the robustness technique to test out of bound (lower
    // & upper) values
    @Test
    ...
    // The following tests creates various Range objects with different range to
    // test
    // the getLowerBound() and getUpperBound() methods.
    // An assert statement is created in each test to see if the return value match
